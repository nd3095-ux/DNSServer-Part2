# DNSServer.py
# Correct submission for DNS Part 2
# Author: Nikica Dokic
...
# -------------------------
# AES Encryption for TXT Exfiltration
# -------------------------
...
encrypted_value = encrypt_with_aes(SECRET_DATA, AES_KEY)  # module-level variable for autograder
